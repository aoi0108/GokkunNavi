document.addEventListener('DOMContentLoaded', () => {
    ...
    const GAME_CONFIG = {
        ...
        MESSAGES: {
            ...
            world: {
                initial: "そなたは世界の平和を託されし伝説の勇者のはず。\nしかし、おお、なんということだろう。邪悪な魔王の魂に体を乗っ取られてしまうとは！そなたが悪に完全に支配されるまで、もう時間がない。もはやこれまで・・かくなる上は、そなたの命と引き換えに世界を救う「魂の解毒剤」を今すぐ飲むしかあるまい・・そなたの決断が、世界の運命を決める。\n準備ができたら、スタートボタンを押すのだ！",
